          ...
          <div className="content-down">
            <div className="options">
              <div className="option-child">
                <div className="icon-child-chuyen-khoa"></div>
                <div className="text-child">
                  <FormattedMessage id="banner.child1" />
                </div>
              </div>
              <div className="option-child">
                <div className="icon-child-tu-xa"></div>
                <div className="text-child">
                  <FormattedMessage id="banner.child2" />
                </div>
              </div>
              <div className="option-child">
                <div className="icon-child-tong-quat"></div>
                <div className="text-child">
                  <FormattedMessage id="banner.child3" />
                </div>
              </div>
              <div className="option-child">
                <div className="icon-child-xet-nghiem"></div>
                <div className="text-child">
                  <FormattedMessage
                    id="banner.child4"
                    values={{ br: <br /> }}
              ...
              <div className="option-child">
                <div className="icon-child-tinh-than"></div>
                <div className="text-child">
                  <FormattedMessage
                    id="banner.child5"
                    values={{ br: <br /> }}
              ...
              <div className="option-child">
                <div className="icon-child-nha-khoa"></div>
                <div className="text-child">
                  <FormattedMessage id="banner.child6" />
                </div>
              </div>
              <div className="option-child">
                <div className="icon-child-phau-thuat"></div>
                <div className="text-child">
                  <FormattedMessage
                    id="banner.child7"
                    values={{ br: <br /> }}
              ...
              <div className="option-child">
                <div className="icon-child-san-pham"></div>
                <div className="text-child">
